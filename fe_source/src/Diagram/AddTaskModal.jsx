...
class AddTask extends React.Component {
  ...
  onModalVisible = () => {
    // 如果编辑
    if (this.props.isEditModal && this.props.modalTask) {
      const _id = this.props.modalTask._id;
      this.getRelatedPersonList(_id);
      // task含有file项, enable preview
      if (this.props.modalTask.filePath) {
        this.setFilePreview();
      }
    }
  }
  ...
  getRelatedPersonList = _id => {
    axios.post(api.getRelatedPerson, {_id})
      .then(res => {
